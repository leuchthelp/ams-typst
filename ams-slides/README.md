...
<p align="center">
A simple <a href="https://typst.app/universe/package/polylux/">polylux</a> slides template based on the AMS working group at Otto-von-Guericke University Magdeburg. Adopted from the ParCIO-typst templates
</p>
...
These are the default options. We recommend leaving the show-rule as-is, such that you can just do `#show ams-theme`, and
